# WireGuard-VPN.
- `WireGuard "VPN"`
![image](https://github.com/TecnologyCASM/WG-Easy_VPN/assets/107158068/b87bda76-c8f1-4b16-97f4-ebb97db3c53b)
...
```shell
git clone https://github.com/TecnologyCASM/WG-Easy_VPN.git
cd WG-Easy_VPN
